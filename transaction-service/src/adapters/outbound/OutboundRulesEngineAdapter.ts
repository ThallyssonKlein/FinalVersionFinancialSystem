...
export default class OutboundRulesEngineAdapter extends Loggable {
    ...
    async determineConfigsForTransactions(defaultConfig: ConfigBO, allConfigs: ConfigBO[], transactions: TransactionFromBankBO[], transactionsGroupedByDate: TransactionsGroupedByDateBO[], traceId: string): Promise<ConfigsForTransactionsBO> {
